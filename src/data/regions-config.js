...
export const REGION_META = {
  ...
  forearm_flex_l:  { id: "forearm_flex_l",  label: "Forearm Flexor (L)",    view: "front" },
  forearm_flex_r:  { id: "forearm_flex_r",  label: "Forearm Flexor (R)",    view: "front" },
...
add_longus_l:        { id: "add_longus_l",        label: "Adductor long(L)",           view: "deep" , side: "front"},
    add_longus_r:        { id: "add_longus_r",        label: "Adductor long (R)",           view: "deep" , side: "front"},
  add_brevis_l:        { id: "add_brevis_l",        label: "Adductor Brevis (L)",     view: "deep", side: "front" },
    ...
    adductor_mag_l:        { id: "adductor_mag_l",        label: "Adductor Magnus (L)",     view: "deep", side: "front" },
    adductor_mag_r:        { id: "adductor_mag_r",        label: "Adductor Magnus (R)",     view: "deep", side: "front" },
    pectineus_l:        { id: "pectineus_l",        label: "Pectineus (L)",          view: "deep" , side: "front"},
    pectineus_r:        { id: "pectineus_r",        label: "Pectineus (R)",          view: "deep" , side: "front"},
...
export const SHAPES = {
  ...
  forearm_flex_l: { type: "path",   d: FOREARM_L },
  forearm_flex_r: { type: "path",   d: FOREARM_L, transform: "scale(-1,1) translate(-200,0)"},
  ...
  transverse_abs_r:  { type: "path",   d: TRANSVERSE_ABS, transform: "scale(-1,1) translate(-200,0)" },
    ...
    adductor_mag_l:        { type: "path",   d: ADD_MAG_L },
    adductor_mag_r:        { type: "path",   d: ADD_MAG_L, transform: "scale(-1,1) translate(-200,0)" },
